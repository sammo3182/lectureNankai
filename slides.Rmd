...
* Low-income group $\rightarrow$ Income inequality <br><br><div class="centered">
<img src="http://st2.depositphotos.com/3343629/11463/i/950/depositphotos_114639548-stock-photo-social-inequality-between-rich-poor.jpg" height = 200 />
</div>
...
* Conflict theory (Brady 2004; Oliver 2001)
    + Inequality $\rightarrow$ awakening $\rightarrow$ fight for redistribution<br><br><div class="centered">
<img src="http://img.gifmagazine.net/gifmagazine/images/463474/original.gif" height = 300 />
</div>
...
* Relative power theory (Solt 2010)
    ...
    + The riches teach the poor <br><br><div class="centered">
<img src="http://4.bp.blogspot.com/-P2ucjgNCfhU/Vx_A0IwQt8I/AAAAAAAAIHE/ZaH5zDUwR_4sWzrGLqhu6m2jQZSnCHFUwCLcB/s1600/9%2BHYPNOSIS.gif" height = 300 />
</div>
...
<img src="image/dotwhisker.jpg" height = 500 />
</div>
...
## Tang, Hu, and Jin 2016
* Research Question
    + Ethnic Inequality in Occupation in China?
    + Education vs. Language?<br><br><div class="centered">
<img src="http://factsanddetails.com/media/2/20080304-minorities%20poster.jpg" height = 300 />
</div>

## Theory

* Educational inequality $\rightarrow$ Job Attainment $\rightarrow$ Income
* Mandarin Proficiency $\rightarrow$ Job Attainment $\rightarrow$ Income
* Object: Han vis-&#224;-vis Uyghur
* Hypotheses:
    1. Equal educational attainment;
    1. Unequal mandarin proficiency;
    1. Unequal high socioeconomic status;
    1. Mandarin proficiency improves Uyghur's socioeconomic attainment

## Data

* 2012 China Labor-Force Dynamics Survey (CLDS)
* 2006–2007 Chinese Ethnicity Survey

## Method and Results

* Equal educational attainment.<br><br><div class="centered">
<img src="image/hanWei.png" height = 450 />
</div>

----

* Unequal mandarin proficiency.<br><br><div class="centered">
<img src="image/manInequal.png" height = 450 width = 800 />
</div>

----

* Unequal high socioeconomic status.<br><br><div class="centered">
<img src="image/jobInequal.png" height = 450 width = 800 />
</div>

----

* Mandarin proficiency improves Uyghur's socioeconomic attainment.<br><br><div class="centered">
...
* Equal education
* Preferred ethnic policy $\rightarrow$ Low Mandarin proficiency $\rightarrow$ Unequal job attainment.
* Biased focus $\rightarrow$ biased conclusion.
